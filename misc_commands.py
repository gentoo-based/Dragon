...
class MiscCommands(commands.Cog):
    ...
    async def help(self, ctx):
        try:
            ...
            embed.add_field(name='l!video', value= 'Lets you send any video', inline=False)
    ...
    async def help_slash(self, interaction: nextcord.Interaction):
        ...
        embed.add_field(name='l!ban', value='Bans a member, self explanatory', inline=False)     
        embed.add_field(name='l!kick', value='Pretty self explanatory', inline=False)     
        embed.add_field(name='l!warn', value='Warns a member, if a member gets 3 warns they will get kicked if they get 6 warns they will get banned.', inline=False)     
        embed.add_field(name='l!clearwarns', value='Clear\'s the warns of a user', inline=False)     
        embed.add_field(name='l!lock', value='Locks a channel', inline=False)     
        embed.add_field(name='l!unlock', value='Unlocks a channel', inline=False)     
        embed.add_field(name='l!addrole', value='Add\'s a role to a user', inline=False)     
        embed.add_field(name='l!removerole', value='Remove\'s a role from a user', inline=False)     
        embed.add_field(name='l!slowmode', value='Add\'s a slowmode to a channel', inline=False)     
        embed.add_field(name='l!clear', value='Clear\'s a specified amount of messages', inline=False)
