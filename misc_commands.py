...
class MiscCommands(commands.Cog):
    ...
    @commands.Bot.slash_command(self, name="echo", description="Echoes your message back to you.")
    ...
    @commands.Bot.slash_command(self, name="joke", description="Tells a random joke.")
    async def joke_slash(self, interaction: nextcord.Interaction):
        jokes = ["Why don't scientists trust atoms? Because they make up everything!", "Why did the chicken go to the seance? To talk to the other side!"]
        await interaction.response.send_message(random.choice(jokes))

    @commands.Bot.slash_command(self, name="fact", description="Tells a random fact.")
    async def fact_slash(self, interaction: nextcord.Interaction):
        facts = ["Did you know? The Eiffel Tower can be 15 cm taller during the summer.", "Did you know? Honey never spoils."]
        await interaction.response.send_message(random.choice(facts))

    @commands.Bot.slash_command(self, name="roast", description="Tells a friendly roast.")
    ...
    @commands.Bot.slash_command(self, name="about", description="Shows information about the bot.")
    ...
    @commands.Bot.slash_command(self, name="help", description="Shows the list of commands.")
    ...
    @commands.Bot.slash_command(self, name="solve", description="Solves a math expression.")
